...
const Projects = () => {
  ...
  useEffect(() => {
    const handleKeyPress = (e) => {
      // Prevent keyboard navigation when user is typing in an input
  ...
  // Get visible projects with positions - memoized for performance
  ...
  // Handle card click
  const handleCardClick = useCallback((project, e) => {
    e.preventDefault();
    e.stopPropagation();
      ...
      <div className="github-cta">
        <div className="github-cta-content">
          ...
          <p className="github-cta-subtitle">
            Visit my GitHub profile to discover additional projects, contributions, and code samples 
